...
class TestPredictRevenueHistory(TransactionCase):
    ...
    def test_03_multi_year_data(self):
        ...
        self.assertEqual(len(test_product_records), 5)  # 3 from test_02 and 2 from test_03
    ...
    def test_06_required_fields(self):
        ...
        # Missing product should raise error
        ...
        # Missing year should raise error
        with self.assertRaises(Exception):
            self.History.create({
                'product_id': self.test_product.id,
                'predict_month': '12',
        ...
        # Missing month should raise error
        with self.assertRaises(Exception):
            self.History.create({
                'product_id': self.test_product.id,
                'predict_year': '2026',
